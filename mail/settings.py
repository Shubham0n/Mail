...
SECRET_KEY = 'django-insecure-$+&a2#+k%erh^ry4b&oe8nb*ya*8$%l@s8c4ofznu2ahy67ek0'
...
# >>> send_mail(subject="hello shubham", message="A standing message", from_email=settings.EMAIL_HOST_USER, recipient_list=[settings.RECIPIENT_ADDRESS])